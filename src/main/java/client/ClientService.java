...
public class ClientService {
    ...
    public long createClient(String name){
        ...
        try {
            ...
            System.out.println("Insert order exception. Reason: " + e.getMessage());
            return -1;
        }
    }
    public long findMaxId(){
        try(ResultSet rs = this.findLastClient.executeQuery()){
            ...
            System.out.println("Select maxId exception. Reason: " + e.getMessage());
        }
        return -1;
    }
    public String getById(long id){
        try{
            ...
            try(ResultSet rs = this.findNameById.executeQuery()){
                ...
                System.out.println("Find name by id exception. Reason: " + e.getMessage());
            }
        }catch(SQLException e) {
            System.out.println("Find name by id exception. Reason: " + e.getMessage());
        }
    ...
    public void setName(long id, String name){
        try{
            ...
            if(!getById(id).equals(name)){
                throw new RuntimeException("Помилка оновлення імені по id: " + id);
            }
        }catch(SQLException e) {
            System.out.println("Update name by id exception. Reason: " + e.getMessage());
        }
    }
    public void deleteById(long id){
        try {
            ...
            }else throw new RuntimeException("Помилка видалення клієнта по id: " + id);
        }catch(SQLException e) {
